    ...
    <div class="footer-b">
		<div class="site-info">
			<?php
                ...
                echo '<a href="' . esc_url( 'https://visionlumbinitoursandtravel.org.com/travel-agency/' ) .'" rel="author" target="_blank">' . esc_html__( 'Travel Agency', 'travel-agency' ) . '</a>' . esc_html__( ' by Vision Lumbini.', 'travel-agency' );
                
                printf( esc_html__( ' Powered by %s', 'travel-agency' ), '<a href="'. esc_url( __( 'https://wordpress.org/', 'travel-agency' ) ) .'" target="_blank">Vision Lumbini Tours and Travel</a> .' );                        
